var skinview = function(global, undefined) {
	'use strict';
	...
	skin.src = 'http://skins.minecraft.net/MinecraftSkins/TVC.png';
	...
	return {
		changeSkin: function (player) {
			skin.src = 'https://skins.minecraft.net/MinecraftSkins/' + player + .png;
		},
